...
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/1.png)
...
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/2.png)
...
$ aws ec2 associate-dhcp-options \
  ...
  --vpc-id ${VPC_ID}
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/3.png)
...
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/4.png)
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/5.png)
...
aws ec2 authorize-security-group-ingress \
  ...
  --cidr 0.0.0.0/0
  ```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/10.png)

![](https://github.com/Demiladee/private-projects/blob/main/img/project21/6.png)
 
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/7.png)
...
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/8.png)
...
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/9.png)
...
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/11.png)
...
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/12.png)
...
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/13.png)
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/14.png)
...
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/15.png)
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/16.png)
...
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/17.png)
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/18.png)
...
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/19.png)
...
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/20.png)
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/21.png)
...
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/22.png)
...
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/23.png)
...
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/24.png)
...
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/25.png)
...
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/26.png)
...
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/27.png)
...
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/28.png)
...
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/29.png)
...
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/30.png)

- Distributing the files to thier respective servers using scp and for loop:

**For Master nodes**

![](https://github.com/Demiladee/private-projects/blob/main/img/project21/31.png)

**For Worker nodes**

![](https://github.com/Demiladee/private-projects/blob/main/img/project21/32.png)
...
EOF
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/33.png)

- Sending the encryption-config.yaml file to the master nodes using scp and a for loop

![](https://github.com/Demiladee/private-projects/blob/main/img/project21/34.png)
...
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/35.png)
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/36.png)
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/37.png)
...
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/38.png)
...
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/40.png)
...
echo ${ETCD_NAME}
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/41.png)
...
EOF
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/42.png)
...
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/43.png)
...
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/44.png)

- Checking the etcd service status:`$ systemctl status etcd`
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/45.png)
...
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/46.png)
...
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/47.png)
...
EOF
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/48.png)
...
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/49.png)
...
EOF
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/50.png)
...
EOF
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/51.png)
...
EOF
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/52.png)
...
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/53.png)
...
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/54.png)
...
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/55.png)

- To reach the Kubernetes API Server publicly:`$ curl --cacert /var/lib/kubernetes/ca.pem https://$INTERNAL_IP:6443/version`

![](https://github.com/Demiladee/private-projects/blob/main/img/project21/56.png)

- To get the status of each component:`$ kubectl get componentstatuses --kubeconfig admin.kubeconfig`

![](https://github.com/Demiladee/private-projects/blob/main/img/project21/57.png)
...
EOF
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/58.png)
...
EOF
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/59.png)
...
EOF
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/60.png)
...
EOF
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/61.png)
...
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/62.png)
...
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/63.png)
...
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/64.png)
...
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/65.png)
...
EOF
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/66.png)
...
EOF
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/67.png)
...
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/68.png)
...
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/69.png)
...
EOF
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/70.png)
...
echo "${WORKER_NAME}"
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/71.png)
...
echo "${WORKER_NAME}"
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/72.png)
...
EOF
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/74.png)
...
EOF
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/75.png)
...
EOF
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/76.png)
...
EOF
```
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/77.png)
...
![](https://github.com/Demiladee/private-projects/blob/main/img/project21/Nodes%20ready.png)
